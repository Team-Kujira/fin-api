...
#
#     PHX_SERVER=true bin/fin_api start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :fin_api, FinApiWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/fin_api/fin_api.db
      """
  ...
  config :fin_api, FinApiWeb.Endpoint,
  ...
  config :fin_api, FinApi.Node, host: host, port: port, websocket: websocket
end
